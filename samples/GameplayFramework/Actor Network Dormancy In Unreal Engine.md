---
title: Actor Network Dormancy in Unreal Engine 5.7 Documentation
source: https://dev.epicgames.com/documentation/unreal-engine/actor-network-dormancy-in-unreal-engine
tags:
  - unreal-engine
  - ue5
  - documentation
  ...
  - gameplay
  - networking
created: 2026-06-04T10:10:19.562478Z
---
...
While the actor channel for a replicated actor will close when it goes dormant, dormant actors still exist on both the server and client. This is different to how [[404|Actor Relevancy]] is handled: dynamic, replicated actors are destroyed on the client when they are no longer relevant. It is worth noting that dormant actors are not checked for relevancy, so if a dormant actor would otherwise go out of relevancy on a client, it is not destroyed on that client (unless you are using a [[Replication Graph In Unreal Engine|Replication Graph]] with the `Net.RepGraph.DormantDynamicActorsDestruction` console variable enabled).
...
For more information about console variables in Unreal Engine, see the [[Console Variables Cplusplus In Unreal Engine|Console Variables]] documentation page.
...
* [network optimization](https://dev.epicgames.com/community/search?query=network+optimization)

Ask questions and help your peers [Developer Forums](https://forums.unrealengine.com/categories?tag=unreal-engine)

Write your own tutorials or read those from others [Learning Library](https://dev.epicgames.com/community/unreal-engine/learning)

* [[Actor Network Dormancy In Unreal Engine|How to Use Network Dormancy]]
* [[Actor Network Dormancy In Unreal Engine|Change an Actor's Network Dormancy]]
* [[Actor Network Dormancy In Unreal Engine|Network Dormancy States]]
* [[Actor Network Dormancy In Unreal Engine|Wake a Dormant Actor]]
* [[Actor Network Dormancy In Unreal Engine|Set Net Dormancy]]
* [[Actor Network Dormancy In Unreal Engine|Flush Net Dormancy]]
* [[Actor Network Dormancy In Unreal Engine|Force Net Update]]
* [[Actor Network Dormancy In Unreal Engine|When to Use Wake Methods]]
* [[Actor Network Dormancy In Unreal Engine|Dormancy with Blueprint Actors]]
* [[Actor Network Dormancy In Unreal Engine|Dormancy and Replication Graph]]
* [[Actor Network Dormancy In Unreal Engine|Debugging Network Dormancy]]
* [[Actor Network Dormancy In Unreal Engine|Logging]]
* [[Actor Network Dormancy In Unreal Engine|Console Variables]]
...
* [[404]]
* [[Replication Graph In Unreal Engine]]
* [[Console Variables Cplusplus In Unreal Engine]]
* [[Actor Network Dormancy In Unreal Engine]]
